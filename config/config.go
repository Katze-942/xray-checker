...
type CLI struct {
	...
	Proxy struct {
		...
		CheckConcurrency int    `name:"proxy-check-concurrency" help:"Maximum number of proxies checked at the same time, 0 means unlimited" default:"0" env:"PROXY_CHECK_CONCURRENCY"`
