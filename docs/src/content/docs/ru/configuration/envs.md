...
Пауза в секундах после завершения полного цикла проверки доступности прокси перед запуском следующего цикла. Циклы проверки прокси не накладываются друг на друга.
...
Максимальное число прокси, проверяемых одновременно. `0` означает параллельные проверки без ограничения.
