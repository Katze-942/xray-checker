...
See Xray Checker in action: [demo-xray-checker.kutovoy.dev](https://demo-xray-checker.kutovoy.dev/)
:::

Xray Checker is a comprehensive monitoring solution designed to verify and track the availability of proxy servers running various [protocols](/configuration/subscription) including VLESS, VMess, Trojan, Shadowsocks, and Hysteria2. Built with modern DevOps practices in mind, it seamlessly integrates with [popular monitoring systems](/integrations/metrics) and provides real-time metrics for your proxy infrastructure.
